...
def get_story(character):
    stories = {
        ...
        "Nova_Equipment": [
        "Nova_Equipment started as a small family-run business in a garage, focusing on repairing and supplying industrial tools to local factories. Over the years, their dedication to quality and customer service allowed them to expand operations. Today, Nova_Equipment is a market leader, operating in multiple countries and providing innovative solutions tailored to meet the needs of global clients.",
        "In 2018, Nova_Equipment worked with a large automotive manufacturing company facing frequent production halts due to outdated machinery. The team at Nova_Equipment conducted a thorough site analysis, developed a fully customized automation solution, and provided training for the client\\'s staff. As a result, the client reported a 50% improvement in operational efficiency and a significant reduction in downtime.",
        "Nova_Equipment has always prioritized sustainability. In 2020, they launched a new product line of energy-efficient industrial tools designed to reduce energy consumption by up to 30%. These products have been adopted by major industries worldwide, helping them achieve their sustainability goals while maintaining high performance and reliability.",
        "One of Nova_Equipment\\'s defining moments came during a critical factory breakdown in 2019. A major pharmaceutical client was on the brink of losing millions in revenue due to equipment failure. Nova_Equipment’s team worked around the clock, sourcing parts and assembling a solution in just 48 hours. Their quick response not only saved the client but also solidified their reputation as a reliable partner in emergencies.",
        "In partnership with leading technology firms, Nova_Equipment introduced AI-driven predictive maintenance systems in 2021. These systems monitor equipment in real time, predict potential failures, and recommend preventive actions. This innovative approach has saved clients millions by reducing unplanned downtime and maintenance costs.",
        "Nova_Equipment strongly believes in empowering their clients. To this end, they organize regular workshops and training sessions where clients\\' technical teams are taught how to maximize the efficiency and lifespan of their equipment. These sessions have received overwhelmingly positive feedback, fostering strong and lasting partnerships.",
        "The year 2020 was challenging for many industries due to the global pandemic, but Nova_Equipment rose to the occasion. They quickly adapted by shifting their operations online, offering virtual consultations, and implementing contactless delivery. This proactive approach ensured uninterrupted service to their clients, even during the most challenging times.",
        ...
        "Some relics are said to be hidden within the heart of volcanoes, where molten lava constantly flows from the earth\\'s core. These relics are often guarded by mythical creatures, ancient beasts, or the harsh trials of nature that no one dares to overcome.",
        "There are relics believed to be buried within the ruins of lost civilizations, hidden beneath the rubble of ancient fortresses. These places are often thought to be cursed, with traps and challenges that continually protect the relics from intruders seeking their power.",
        "In some cases, relics are said to rest deep beneath the oceans, in the sunken cities of forgotten gods. Only those brave enough to dive into the abyss or powerful enough to navigate its currents can retrieve the treasures, but even then, they must face the wrath of the sea\\'s guardians.",
        "Relics can sometimes be found in remote deserts, where endless sand dunes hide ancient temples or crypts. These places are often riddled with illusions and mirages, causing many would-be treasure hunters to lose their way or fall into the traps set by long-forgotten protectors.",
        "Other relics are located in the high, inaccessible reaches of mountains, where only the most determined adventurers can ascend. These mountains are often shrouded in constant storms, snow, or mist, and the relics are said to only reveal themselves to those who prove their worth by overcoming the trials of nature.",
        "There are also relics found in enchanted forests, where time itself seems to bend and twist. These forests are alive with magic, and the relics hidden within them are protected by ancient guardians or mystical beings that test those who seek them.",
        "Relics can also be found in forgotten crypts or burial grounds of legendary warriors and kings, where their final resting places are marked by magnificent tombs. These places are often filled with the spirits of the past, and the relics hidden there can only be claimed by those who pass the trials set by the spirits themselves.",
        "Some relics are said to rest on floating islands or in skyward temples, where gravity does not seem to apply. These locations are reachable only through magical means or by the bravest of adventurers, and the relics are said to be imbued with the power of the heavens themselves.",
        "Occasionally, relics are hidden within the depths of dark caverns or forgotten dungeons, protected by puzzles, riddles, or monstrous guardians. The deeper one ventures into these dangerous places, the closer they come to uncovering the secrets of the ancient world."
        ],
        "Magic_Formation_Circle": [
        "The Magic Formation Circle is a powerful and intricate array of symbols and runes, used to harness and channel arcane energy. It is often found in ancient temples, hidden crypts, or deep within sacred groves, where only those with the proper knowledge can decipher its secrets.",
        "A typical Magic Formation Circle consists of several concentric rings, each with its own set of symbols that represent different elements or forces. These rings are designed to balance and amplify the energy flowing through the circle, ensuring that the magic is controlled and stable.",
        "The outermost ring of the circle is usually inscribed with symbols of protection and containment. These symbols create a barrier that prevents the magic from spilling out and causing harm to the surrounding area. The second ring often contains runes that focus the magical energy, directing it toward the central core.",
        "In the center of the Magic Formation Circle lies the most powerful rune, often referred to as the \\\"Focal Point Rune.\\\" This rune is the key to unlocking the full potential of the circle, and its activation requires a great deal of concentration and power from the practitioner. Once activated, the circle channels raw magical energy into the user\\'s desired effect.",
        "The creation of a Magic Formation Circle requires specific rituals and offerings to the elemental spirits or deities associated with the magic being summoned. These rituals may involve chanting, blood sacrifice, or the offering of rare magical ingredients to ensure that the circle functions properly.",
        "Some Magic Formation Circles are designed for specific types of magic, such as summoning, healing, or elemental control. Each type of circle requires different symbols and layouts to work effectively, and even the smallest mistake in its construction can result in disastrous consequences.",
        "Once the Magic Formation Circle is complete, the practitioner must stand at the center, aligning themselves with the circle\\'s energy flow. At this point, the magic is channeled through their body, allowing them to perform powerful spells, summon beings, or manipulate elements.",
        "In many cultures, the Magic Formation Circle is considered a sacred tool, often reserved for high-level mages, priests, or scholars who have spent years studying the arcane arts. It is said that only those with a pure heart and clear intent can successfully use the circle without causing chaos or destruction.",
...
def create_cards_database():
    ...
    critical_rate = 10
    critical_resistance_rate = 10
    ignore_critical_rate = 10
    penetration_rate = 10
    penetration_resistance_rate = 10
    evasion_rate = 10
    damage_absorption_rate = 10
    ignore_damage_absorption_rate = 10
    absorbed_damage_rate = 10
    vitality_regeneration_rate = 10
    vitality_regeneration_resistance_rate = 10
    accuracy_rate = 10
    lifesteal_rate = 10
    ...
    resistance_rate = 10
    combo_rate = 10
    ignore_combo_rate = 10
    combo_damage_rate = 10
    combo_resistance_rate = 10
    stun_rate = 10
    ignore_stun_rate = 10
    reflection_rate = 10
    ignore_reflection_rate = 10
    reflection_damage_rate = 10
    reflection_resistance_rate = 10
    mana = 100
    ...
    normal_damage_rate = 10
    normal_resistance_rate = 10
    skill_damage_rate = 10
    skill_resistance_rate = 10
    rare="SR"
    clan=""
    price=100000
                ...
                for file_name in os.listdir(current_dir):
                    if file_name.endswith(".jpg") or file_name.endswith("png"):
                        ...
                        power = calculate_power(
                            health, physical_attack, physical_defense, magical_attack, magical_defense,
                            chemical_attack, chemical_defense, atomic_attack, atomic_defense, mental_attack, mental_defense,
                            speed, critical_rate, critical_damage_rate, critical_resistance_rate, ignore_critical_rate, 
                            penetration_rate, penetration_resistance_rate, evasion_rate, 
                            damage_absorption_rate, ignore_damage_absorption_rate, absorbed_damage_rate, 
                            vitality_regeneration_rate, vitality_regeneration_resistance_rate, accuracy_rate, lifesteal_rate, 
                        ...
                        with open('test.txt', 'a') as file:
                            file.write(
                                ...
                                + str(critical_resistance_rate or 0) + ","
                                + str(ignore_critical_rate or 0) + ","
                                + str(penetration_rate or 0) + ","
                                + str(penetration_resistance_rate or 0) + ","
                                + str(evasion_rate or 0) + ","
                                + str(damage_absorption_rate or 0) + ","
                                + str(ignore_damage_absorption_rate  or 0) + ","
                                + str(absorbed_damage_rate  or 0) + ","
                                + str(vitality_regeneration_rate or 0) + ","
                                + str(vitality_regeneration_resistance_rate or 0) + ","
                                ...
                                + str(combo_rate or 0) + ","
                                + str(ignore_combo_rate or 0) + ","
                                + str(combo_damage_rate or 0) + ","
                                + str(combo_resistance_rate or 0) + ","
                                + str(stun_rate or 0) + ","
                                + str(ignore_stun_rate or 0) + ","
                                + str(reflection_rate or 0) + ","
                                + str(ignore_reflection_rate or 0) + ","
                                + str(reflection_damage_rate or 0) + ","
                                + str(reflection_resistance_rate or 0) + ","
                                + str(mana or 0) + ","
                                ...
                                + str(normal_damage_rate or 0) + ","
                                + str(normal_resistance_rate or 0) + ","
                                + str(skill_damage_rate or 0) + ","
                                + str(skill_resistance_rate or 0) + ",'"
                                + (story or '') + "');\n"
                            )
...
def create_captain_database():
    ...
    critical_rate = 20
    critical_resistance_rate = 20
    ignore_critical_rate = 20
    penetration_rate = 20
    penetration_resistance_rate = 20
    evasion_rate = 20
    damage_absorption_rate = 20
    ignore_damage_absorption_rate = 20
    absorbed_damage_rate = 20
    vitality_regeneration_rate = 20
    vitality_regeneration_resistance_rate = 20
    accuracy_rate = 20
    lifesteal_rate = 20
    ...
    resistance_rate = 20
    combo_rate = 20
    ignore_combo_rate = 20
    combo_damage_rate = 20
    combo_resistance_rate = 20
    stun_rate = 20
    ignore_stun_rate = 20
    reflection_rate = 20
    ignore_reflection_rate = 20
    reflection_damage_rate = 20
    reflection_resistance_rate = 20
    mana = 100
    ...
    normal_damage_rate = 20
    normal_resistance_rate = 20
    skill_damage_rate = 20
    skill_resistance_rate = 20
    rare="LG"
    path=""
    for root, dirs, files in os.walk(cards_dir):
        current_dir=os.path.basename(root)
        ...
        for dir_name in dirs:
            ...
            for file_name in os.listdir(current_dir):
                if file_name.endswith(".jpg") or file_name.endswith("png"):
                    ...
                    with open('test.txt', 'a') as file:
                        file.write(
                            "insert into card_captains values ("
                            + str(id) + ",'"
                            + (name or '') + "','"
                            + (path or '') + "','"
                            + (rare or '') + "',"
...
def create_colonel_database():
    ...
    critical_rate = 30
    critical_resistance_rate = 30
    ignore_critical_rate = 30
    penetration_rate = 30
    penetration_resistance_rate = 30
    evasion_rate = 30
    damage_absorption_rate = 30
    ignore_damage_absorption_rate = 30
    absorbed_damage_rate = 30
    vitality_regeneration_rate = 30
    vitality_regeneration_resistance_rate = 30
    accuracy_rate = 30
    lifesteal_rate = 30
    ...
    resistance_rate = 30
    combo_rate = 30
    ignore_combo_rate = 30
    combo_damage_rate = 30
    combo_resistance_rate = 30
    stun_rate = 30
    ignore_stun_rate = 30
    reflection_rate = 30
    ignore_reflection_rate = 30
    reflection_damage_rate = 30
    reflection_resistance_rate = 30
    mana = 100
    ...
    normal_damage_rate = 30
    normal_resistance_rate = 30
    skill_damage_rate = 30
    skill_resistance_rate = 30
    rare="LG"
    path=""
    for root, dirs, files in os.walk(cards_dir):
        current_dir=os.path.basename(root)
        ...
        for dir_name in dirs:
            ...
            for file_name in os.listdir(current_dir):
                if file_name.endswith(".jpg") or file_name.endswith("png"):
                    ...
                    with open('test.txt', 'a') as file:
                        file.write(
                            "insert into card_colonels values ("
                            + str(id) + ",'"
                            + (name or '') + "','"
                            + (path or '') + "','"
                            + (rare or '') + "',"
...
def create_general_database():
    ...
    critical_rate = 40
    critical_resistance_rate = 40
    ignore_critical_rate = 40
    penetration_rate = 40
    penetration_resistance_rate = 40
    evasion_rate = 40
    damage_absorption_rate = 40
    ignore_damage_absorption_rate = 40
    absorbed_damage_rate = 40
    vitality_regeneration_rate = 40
    vitality_regeneration_resistance_rate = 40
    accuracy_rate = 40
    lifesteal_rate = 40
    ...
    resistance_rate = 40
    combo_rate = 40
    ignore_combo_rate = 40
    combo_damage_rate = 40
    combo_resistance_rate = 40
    stun_rate = 40
    ignore_stun_rate = 40
    reflection_rate = 40
    ignore_reflection_rate = 40
    reflection_damage_rate = 40
    reflection_resistance_rate = 40
    mana = 100
    ...
    normal_damage_rate = 40
    normal_resistance_rate = 40
    skill_damage_rate = 40
    skill_resistance_rate = 40
    rare="LG"
    path=""
    for root, dirs, files in os.walk(cards_dir):
        current_dir=os.path.basename(root)
        ...
        for dir_name in dirs:
            ...
            for file_name in os.listdir(current_dir):
                if file_name.endswith(".jpg") or file_name.endswith("png"):
                    ...
                    with open('test.txt', 'a') as file:
                        file.write(
                            "insert into card_generals values ("
                            + str(id) + ",'"
                            + (name or '') + "','"
                            + (path or '') + "','"
                            + (rare or '') + "',"
...
def create_admiral_database():
    ...
    critical_rate = 50
    critical_resistance_rate = 50
    ignore_critical_rate = 50
    penetration_rate = 50
    penetration_resistance_rate = 50
    evasion_rate = 50
    damage_absorption_rate = 50
    ignore_damage_absorption_rate = 50
    absorbed_damage_rate = 50
    vitality_regeneration_rate = 50
    vitality_regeneration_resistance_rate = 50
    accuracy_rate = 50
    lifesteal_rate = 50
    ...
    resistance_rate = 50
    combo_rate = 50
    ignore_combo_rate = 50
    combo_damage_rate = 50
    combo_resistance_rate = 50
    stun_rate = 50
    ignore_stun_rate = 50
    reflection_rate = 50
    ignore_reflection_rate = 50
    reflection_damage_rate = 50
    reflection_resistance_rate = 50
    mana = 100
    ...
    normal_damage_rate = 50
    normal_resistance_rate = 50
    skill_damage_rate = 50
    skill_resistance_rate = 50
    rare="LG"
    path=""
    for root, dirs, files in os.walk(cards_dir):
        current_dir=os.path.basename(root)
        ...
        for dir_name in dirs:
            ...
            for file_name in os.listdir(current_dir):
                if file_name.endswith(".jpg") or file_name.endswith("png"):
                    ...
                    with open('test.txt', 'a') as file:
                        file.write(
                            "insert into card_admirals values ("
                            + str(id) + ",'"
                            + (name or '') + "','"
                            + (path or '') + "','"
                            + (rare or '') + "',"
            ...
            if "LG" in dir_name:
                ...
                for file_name in os.listdir(current_dir):
                    if file_name.endswith(".jpg") or file_name.endswith("png"):
                        ...
                        name=name.replace("_"," ")
                        description=""
                        if "Ultimate_Evironment" in current_name:
                            health=5000
                        ...
                        elif "Ultimate_Increase" in current_name:
                            description="'Increase "+ str(health) +"% for all your military'"
                        elif "Ultimate_Decrease" in current_name:
...
def create_magic_formation_circle_database():
...
def create_arena_database():
    ...
    with open('arena.txt', 'a') as file:
        for i, mode in enumerate(arena_modes, start=1):
            query = f"INSERT INTO arena_mode (id, mode) VALUES ({i}, '{mode}');\n"
            file.write(query)

create_captain_database()
create_colonel_database()
create_general_database()
create_admiral_database()
