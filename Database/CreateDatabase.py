...
def create_campaign ():
    Equipment=[
        ...
        "Uni_Equipment","Zodiac_Equipment","Zpower_Equipment"
    ]
    Data=[
    ...
    for equipment in Equipment:
        for i in range (100):
            with open('campaign.txt', 'a') as file:
                ...
                file.write("insert into campaign_detail_card_heroes values("+str(count)+","+str(1)+","+str(enemy1)+",'Chapter "+ str(i+1)+"');\n")
                file.write("insert into campaign_detail_card_heroes values("+str(count)+","+str(1)+","+str(enemy2)+",'Chapter "+ str(i+1)+"');\n")
                file.write("insert into campaign_detail_card_heroes values("+str(count)+","+str(1)+","+str(enemy3)+",'Chapter "+ str(i+1)+"');\n")
                file.write("insert into campaign_detail_card_heroes values("+str(count)+","+str(1)+","+str(enemy4)+",'Chapter "+ str(i+1)+"');\n")
                file.write("insert into campaign_detail_card_heroes values("+str(count)+","+str(1)+","+str(enemy5)+",'Chapter "+ str(i+1)+"');\n")
                file.write("insert into campaign_detail_card_heroes values("+str(count)+","+str(1)+","+str(enemy6)+",'Chapter "+ str(i+1)+"');\n")
                ...
                file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(2)+","+str(enemy1)+",'Chapter "+ str(i+1)+"');\n")
                file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(2)+","+str(enemy2)+",'Chapter "+ str(i+1)+"');\n")
                file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(2)+","+str(enemy3)+",'Chapter "+ str(i+1)+"');\n")
                file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(2)+","+str(enemy4)+",'Chapter "+ str(i+1)+"');\n")
                file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(2)+","+str(enemy5)+",'Chapter "+ str(i+1)+"');\n")
                file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(2)+","+str(enemy6)+",'Chapter "+ str(i+1)+"');\n")
                ...
                file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(3)+","+str(enemy1)+",'Chapter "+ str(i+1)+"');\n")
                file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(3)+","+str(enemy2)+",'Chapter "+ str(i+1)+"');\n")
                file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(3)+","+str(enemy3)+",'Chapter "+ str(i+1)+"');\n")
                file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(3)+","+str(enemy4)+",'Chapter "+ str(i+1)+"');\n")
                file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(3)+","+str(enemy5)+",'Chapter "+ str(i+1)+"');\n")
                file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(3)+","+str(enemy6)+",'Chapter "+ str(i+1)+"');\n")
                ...
                file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(4)+","+str(enemy1)+",'Chapter "+ str(i+1)+"');\n")
                file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(4)+","+str(enemy2)+",'Chapter "+ str(i+1)+"');\n")
                file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(4)+","+str(enemy3)+",'Chapter "+ str(i+1)+"');\n")
                file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(4)+","+str(enemy4)+",'Chapter "+ str(i+1)+"');\n")
                file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(4)+","+str(enemy5)+",'Chapter "+ str(i+1)+"');\n")
                file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(4)+","+str(enemy6)+",'Chapter "+ str(i+1)+"');\n")
                ...
                file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(5)+","+str(enemy1)+",'Chapter "+ str(i+1)+"');\n")
                file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(5)+","+str(enemy2)+",'Chapter "+ str(i+1)+"');\n")
                file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(5)+","+str(enemy3)+",'Chapter "+ str(i+1)+"');\n")
                file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(5)+","+str(enemy4)+",'Chapter "+ str(i+1)+"');\n")
                file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(5)+","+str(enemy5)+",'Chapter "+ str(i+1)+"');\n")
                file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(5)+","+str(enemy6)+",'Chapter "+ str(i+1)+"');\n")
                ...
                file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(6)+","+str(enemy1)+",'Chapter "+ str(i+1)+"');\n")
                file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(6)+","+str(enemy2)+",'Chapter "+ str(i+1)+"');\n")
                file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(6)+","+str(enemy3)+",'Chapter "+ str(i+1)+"');\n")
                file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(6)+","+str(enemy4)+",'Chapter "+ str(i+1)+"');\n")
                file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(6)+","+str(enemy5)+",'Chapter "+ str(i+1)+"');\n")
                file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(6)+","+str(enemy6)+",'Chapter "+ str(i+1)+"');\n")
                ...
                file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(7)+","+str(enemy1)+",'Chapter "+ str(i+1)+"');\n")
                file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(7)+","+str(enemy2)+",'Chapter "+ str(i+1)+"');\n")
                file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(7)+","+str(enemy3)+",'Chapter "+ str(i+1)+"');\n")
                file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(7)+","+str(enemy4)+",'Chapter "+ str(i+1)+"');\n")
                file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(7)+","+str(enemy5)+",'Chapter "+ str(i+1)+"');\n")
                file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(7)+","+str(enemy6)+",'Chapter "+ str(i+1)+"');\n")
                ...
                file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(8)+","+str(enemy1)+",'Chapter "+ str(i+1)+"');\n")
                file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(8)+","+str(enemy2)+",'Chapter "+ str(i+1)+"');\n")
                file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(8)+","+str(enemy3)+",'Chapter "+ str(i+1)+"');\n")
                file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(8)+","+str(enemy4)+",'Chapter "+ str(i+1)+"');\n")
                file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(8)+","+str(enemy5)+",'Chapter "+ str(i+1)+"');\n")
                file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(8)+","+str(enemy6)+",'Chapter "+ str(i+1)+"');\n")
                ...
                file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(9)+","+str(enemy1)+",'Chapter "+ str(i+1)+"');\n")
                file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(9)+","+str(enemy2)+",'Chapter "+ str(i+1)+"');\n")
                file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(9)+","+str(enemy3)+",'Chapter "+ str(i+1)+"');\n")
                file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(9)+","+str(enemy4)+",'Chapter "+ str(i+1)+"');\n")
                file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(9)+","+str(enemy5)+",'Chapter "+ str(i+1)+"');\n")
                file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(9)+","+str(enemy6)+",'Chapter "+ str(i+1)+"');\n")
                ...
                file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(10)+","+str(enemy1)+",'Chapter "+ str(i+1)+"');\n")
                file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(10)+","+str(enemy2)+",'Chapter "+ str(i+1)+"');\n")
                file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(10)+","+str(enemy3)+",'Chapter "+ str(i+1)+"');\n")
                file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(10)+","+str(enemy4)+",'Chapter "+ str(i+1)+"');\n")
                file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(10)+","+str(enemy5)+",'Chapter "+ str(i+1)+"');\n")
                file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(10)+","+str(enemy6)+",'Chapter "+ str(i+1)+"');\n")
    ...
    for i in range (100):
        with open('campaign.txt', 'a') as file:
            file.write("insert into campaigns values ("+ str(count)+ ",'Chapter "+ str(i+1)+"','"+ str("Main story")+"','"
                + str(equipment)+"','"+ str("Normal") +"',"+str(level)+",'"+ str(description) +"');\n")
            strength_multiplier=i
            level=i
            enemies = random.sample(range(1, 40001), 6) 
            ...
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(11)+","+str(enemy1)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(11)+","+str(enemy2)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(11)+","+str(enemy3)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(11)+","+str(enemy4)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(11)+","+str(enemy5)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(11)+","+str(enemy6)+",'Chapter "+ str(i+1)+"');\n")
            ...
            file.write("insert into campaign_detail_card_heroes values("+str(count)+","+str(12)+","+str(enemy1)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values("+str(count)+","+str(12)+","+str(enemy2)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values("+str(count)+","+str(12)+","+str(enemy3)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values("+str(count)+","+str(12)+","+str(enemy4)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values("+str(count)+","+str(12)+","+str(enemy5)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values("+str(count)+","+str(12)+","+str(enemy6)+",'Chapter "+ str(i+1)+"');\n")
            ...
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(13)+","+str(enemy1)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(13)+","+str(enemy2)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(13)+","+str(enemy3)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(13)+","+str(enemy4)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(13)+","+str(enemy5)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(13)+","+str(enemy6)+",'Chapter "+ str(i+1)+"');\n")
            ...
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(14)+","+str(enemy1)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(14)+","+str(enemy2)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(14)+","+str(enemy3)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(14)+","+str(enemy4)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(14)+","+str(enemy5)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(14)+","+str(enemy6)+",'Chapter "+ str(i+1)+"');\n")
            ...
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(15)+","+str(enemy1)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(15)+","+str(enemy2)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(15)+","+str(enemy3)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(15)+","+str(enemy4)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(15)+","+str(enemy5)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(15)+","+str(enemy6)+",'Chapter "+ str(i+1)+"');\n")
            ...
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(16)+","+str(enemy1)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(16)+","+str(enemy2)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(16)+","+str(enemy3)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(16)+","+str(enemy4)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(16)+","+str(enemy5)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(16)+","+str(enemy6)+",'Chapter "+ str(i+1)+"');\n")
            ...
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(17)+","+str(enemy1)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(17)+","+str(enemy2)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(17)+","+str(enemy3)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(17)+","+str(enemy4)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(17)+","+str(enemy5)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(17)+","+str(enemy6)+",'Chapter "+ str(i+1)+"');\n")
            ...
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(18)+","+str(enemy1)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(18)+","+str(enemy2)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(18)+","+str(enemy3)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(18)+","+str(enemy4)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(18)+","+str(enemy5)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(18)+","+str(enemy6)+",'Chapter "+ str(i+1)+"');\n")
            ...
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(19)+","+str(enemy1)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(19)+","+str(enemy2)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(19)+","+str(enemy3)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(19)+","+str(enemy4)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(19)+","+str(enemy5)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(19)+","+str(enemy6)+",'Chapter "+ str(i+1)+"');\n")
            ...
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(20)+","+str(enemy1)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(20)+","+str(enemy2)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(20)+","+str(enemy3)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(20)+","+str(enemy4)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(20)+","+str(enemy5)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(20)+","+str(enemy6)+",'Chapter "+ str(i+1)+"');\n")
            ...
            file.write("insert into campaign_detail_card_heroes values("+str(count)+","+str(21)+","+str(enemy1)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values("+str(count)+","+str(21)+","+str(enemy2)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values("+str(count)+","+str(21)+","+str(enemy3)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values("+str(count)+","+str(21)+","+str(enemy4)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values("+str(count)+","+str(21)+","+str(enemy5)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values("+str(count)+","+str(21)+","+str(enemy6)+",'Chapter "+ str(i+1)+"');\n")
            ...
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(22)+","+str(enemy1)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(22)+","+str(enemy2)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(22)+","+str(enemy3)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(22)+","+str(enemy4)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(22)+","+str(enemy5)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(22)+","+str(enemy6)+",'Chapter "+ str(i+1)+"');\n")
            ...
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(23)+","+str(enemy1)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(23)+","+str(enemy2)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(23)+","+str(enemy3)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(23)+","+str(enemy4)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(23)+","+str(enemy5)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(23)+","+str(enemy6)+",'Chapter "+ str(i+1)+"');\n")
            ...
            file.write("insert into campaign_detail_card_heroes values("+str(count)+","+str(24)+","+str(enemy1)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values("+str(count)+","+str(24)+","+str(enemy2)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values("+str(count)+","+str(24)+","+str(enemy3)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values("+str(count)+","+str(24)+","+str(enemy4)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values("+str(count)+","+str(24)+","+str(enemy5)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values("+str(count)+","+str(24)+","+str(enemy6)+",'Chapter "+ str(i+1)+"');\n")
            ...
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(25)+","+str(enemy1)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(25)+","+str(enemy2)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(25)+","+str(enemy3)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(25)+","+str(enemy4)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(25)+","+str(enemy5)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(25)+","+str(enemy6)+",'Chapter "+ str(i+1)+"');\n")
            ...
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(26)+","+str(enemy1)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(26)+","+str(enemy2)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(26)+","+str(enemy3)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(26)+","+str(enemy4)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(26)+","+str(enemy5)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(26)+","+str(enemy6)+",'Chapter "+ str(i+1)+"');\n")
            ...
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(27)+","+str(enemy1)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(27)+","+str(enemy2)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(27)+","+str(enemy3)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(27)+","+str(enemy4)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(27)+","+str(enemy5)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(27)+","+str(enemy6)+",'Chapter "+ str(i+1)+"');\n")
            ...
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(28)+","+str(enemy1)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(28)+","+str(enemy2)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(28)+","+str(enemy3)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(28)+","+str(enemy4)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(28)+","+str(enemy5)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(28)+","+str(enemy6)+",'Chapter "+ str(i+1)+"');\n")
            ...
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(29)+","+str(enemy1)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(29)+","+str(enemy2)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(29)+","+str(enemy3)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(29)+","+str(enemy4)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(29)+","+str(enemy5)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(29)+","+str(enemy6)+",'Chapter "+ str(i+1)+"');\n")
            ...
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(30)+","+str(enemy1)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(30)+","+str(enemy2)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(30)+","+str(enemy3)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(30)+","+str(enemy4)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(30)+","+str(enemy5)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(30)+","+str(enemy6)+",'Chapter "+ str(i+1)+"');\n")
            ...
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(31)+","+str(enemy1)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(31)+","+str(enemy2)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(31)+","+str(enemy3)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(31)+","+str(enemy4)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(31)+","+str(enemy5)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(31)+","+str(enemy6)+",'Chapter "+ str(i+1)+"');\n")
            ...
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(32)+","+str(enemy1)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(32)+","+str(enemy2)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(32)+","+str(enemy3)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(32)+","+str(enemy4)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(32)+","+str(enemy5)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(32)+","+str(enemy6)+",'Chapter "+ str(i+1)+"');\n")
            ...
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(33)+","+str(enemy1)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(33)+","+str(enemy2)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(33)+","+str(enemy3)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(33)+","+str(enemy4)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(33)+","+str(enemy5)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(33)+","+str(enemy6)+",'Chapter "+ str(i+1)+"');\n")
            ...
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(34)+","+str(enemy1)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(34)+","+str(enemy2)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(34)+","+str(enemy3)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(34)+","+str(enemy4)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(34)+","+str(enemy5)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(34)+","+str(enemy6)+",'Chapter "+ str(i+1)+"');\n")
            ...
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(35)+","+str(enemy1)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(35)+","+str(enemy2)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(35)+","+str(enemy3)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(35)+","+str(enemy4)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(35)+","+str(enemy5)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(35)+","+str(enemy6)+",'Chapter "+ str(i+1)+"');\n")
            ...
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(36)+","+str(enemy1)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(36)+","+str(enemy2)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(36)+","+str(enemy3)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(36)+","+str(enemy4)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(36)+","+str(enemy5)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(36)+","+str(enemy6)+",'Chapter "+ str(i+1)+"');\n")
            ...
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(37)+","+str(enemy1)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(37)+","+str(enemy2)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(37)+","+str(enemy3)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(37)+","+str(enemy4)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(37)+","+str(enemy5)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(37)+","+str(enemy6)+",'Chapter "+ str(i+1)+"');\n")
            ...
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(38)+","+str(enemy1)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(38)+","+str(enemy2)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(38)+","+str(enemy3)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(38)+","+str(enemy4)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(38)+","+str(enemy5)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(38)+","+str(enemy6)+",'Chapter "+ str(i+1)+"');\n")
            ...
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(39)+","+str(enemy1)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(39)+","+str(enemy2)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(39)+","+str(enemy3)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(39)+","+str(enemy4)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(39)+","+str(enemy5)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(39)+","+str(enemy6)+",'Chapter "+ str(i+1)+"');\n")
            ...
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(40)+","+str(enemy1)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(40)+","+str(enemy2)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(40)+","+str(enemy3)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(40)+","+str(enemy4)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(40)+","+str(enemy5)+",'Chapter "+ str(i+1)+"');\n")
            file.write("insert into campaign_detail_card_heroes values ("+str(count)+","+str(40)+","+str(enemy6)+",'Chapter "+ str(i+1)+"');\n")
