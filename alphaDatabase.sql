...
create table card_heroes(
	...
	critical_resistance_rate DOUBLE NOT NULL, 
	ignore_critical_rate DOUBLE NOT NULL, 
	penetration_rate DOUBLE NOT NULL,
    penetration_resistance_rate DOUBLE NOT NULL,
	evasion_rate DOUBLE NOT NULL,
	damage_absorption_rate DOUBLE NOT NULL,
	ignore_damage_absorption_rate DOUBLE NOT NULL, 
	absorbed_damage_rate DOUBLE NOT NULL, 
	vitality_regeneration_rate DOUBLE NOT NULL,
	vitality_regeneration_resistance_rate DOUBLE  NOT NULL,
	...
	ignore_combo_rate DOUBLE NOT NULL, 
	combo_damage_rate DOUBLE NOT NULL, 
	combo_resistance_rate DOUBLE  NOT NULL, 
	stun_rate DOUBLE  NOT NULL, 
	ignore_stun_rate DOUBLE NOT NULL, 
	reflection_rate DOUBLE NOT NULL,  
	ignore_reflection_rate DOUBLE NOT NULL, 
	reflection_damage_rate DOUBLE NOT NULL, 
	reflection_resistance_rate DOUBLE  NOT NULL, 
	mana float NOT NULL,
	...
	normal_damage_rate DOUBLE NOT NULL, 
	normal_resistance_rate DOUBLE NOT NULL, 
	skill_damage_rate DOUBLE NOT NULL, 
	skill_resistance_rate DOUBLE NOT NULL, 
    description TEXT
);
...
create table user_stats(
	...
	all_critical_resistance_rate DOUBLE NOT NULL, 
	all_ignore_critical_rate DOUBLE NOT NULL, 
	all_penetration_rate DOUBLE NOT NULL,
    all_penetration_resistance_rate DOUBLE NOT NULL,
	all_evasion_rate DOUBLE NOT NULL,
	all_damage_absorption_rate DOUBLE NOT NULL,
	all_ignore_damage_absorption_rate DOUBLE NOT NULL, 
	all_absorbed_damage_rate DOUBLE NOT NULL, 
	all_vitality_regeneration_rate DOUBLE NOT NULL,
	all_vitality_regeneration_resistance_rate DOUBLE  NOT NULL,
	...
	all_ignore_combo_rate DOUBLE NOT NULL, 
	all_combo_damage_rate DOUBLE NOT NULL, 
	all_combo_resistance_rate DOUBLE  NOT NULL, 
	all_stun_rate DOUBLE  NOT NULL, 
	all_ignore_stun_rate DOUBLE NOT NULL, 
	all_reflection_rate DOUBLE NOT NULL,  
	all_ignore_reflection_rate DOUBLE NOT NULL, 
	all_reflection_damage_rate DOUBLE NOT NULL, 
	all_reflection_resistance_rate DOUBLE  NOT NULL, 
	...
	all_normal_damage_rate DOUBLE NOT NULL, 
	all_normal_resistance_rate DOUBLE NOT NULL, 
	all_skill_damage_rate DOUBLE NOT NULL, 
	all_skill_resistance_rate DOUBLE NOT NULL, 
...
CREATE TABLE user_master_board(
	user_id varchar(255) not null,
    name varchar(100),
    node_id varchar(255) NOT NULL,
    rank_level varchar(100),
    ...
    PRIMARY KEY (user_id, name, node_id),
    FOREIGN KEY (user_id) REFERENCES users(id),
    FOREIGN KEY (name, node_id) REFERENCES master_board(name, node_id)
);
