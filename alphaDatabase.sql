...
create table user_stats(
    ...
    all_speed double,
    all_critical_damage_rate double,
    all_critical_rate double,
    all_penetration_rate double,
    all_evasion_rate double,
    all_damage_absorption_rate double,
    all_vitality_regeneration_rate double,
    all_accuracy_rate double,
    all_lifesteal_rate double,
    all_shield_strength double,
    all_tenacity double,
    all_resistance_rate double,
    all_combo_rate double, 
    all_reflection_rate double,  
    all_mana float,
    all_mana_regeneration_rate double,
    all_damage_to_different_faction_rate double, 
    all_resistance_to_different_faction_rate double,
    all_damage_to_same_faction_rate double,
    all_resistance_to_same_faction_rate double ,
